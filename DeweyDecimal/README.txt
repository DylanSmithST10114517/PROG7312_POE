...
Once on homepage you can click on the "Replacing Books" link, this will give the option to choose either "Easy", "Medium" or "Hard" game modes.

-"Easy" 5 books, 30 seconds
-"Medium" 10 books, 30 seconds
-"Hard" 10 books, 25 seconds

Once a game mode is selected the page opens and the countdown timer starts, the user will have to drag the books into the correct positions 
before the timer runs out in order to win the game.
